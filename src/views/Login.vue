  ...
  <div class="auth-page">
    ...
    <div class="auth-container">
      ...
      <div class="auth-tabs">
        ...
        <router-link to="/signup" class="tab">Cadastro</router-link>
      </div>
      ...
      <div class="auth-content">
        ...
        <form @submit.prevent="handleLogin" class="auth-form">
          ...
          <div class="form-group">
            <div class="password-header">
              ...
              <a href="#" class="forgot-password" @click.prevent="forgotPassword">Esqueceu a senha?</a>
            </div>
            <div class="input-container">
              <span class="input-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="auth-footer">
          ...
          <router-link to="/signup" class="auth-link">Criar uma conta</router-link>
        </div>
      </div>
    </div>
  </div>
...
const forgotPassword = () => {
  ...
  alert('Funcionalidade de recuperação de senha será implementada no futuro.');
};
